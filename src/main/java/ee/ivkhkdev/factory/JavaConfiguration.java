...
public class JavaConfiguration implements Configuration{
    ...
    private void init(){
        try {
            ...
            this.map.put("libraryCartAppHelper",new LibraryCardAppHelper((Input)map.get("input"),(BookService)map.get("bookService"),(UserService)map.get("userService")));
            this.map.put("libraryCartRepository",new Storage<>("libraryCarts"));
            this.map.put("libraryCardService",new LibraryCardService((LibraryCardAppHelper) map.get("libraryCartAppHelper"), (Repository) map.get("libraryCartRepository")));
